  ...
  <div class="wrapper">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="<?php echo base_url(); ?>/public/assets/dist/img/user1-128x128.jpg" alt="User Avatar"
            ...
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="<?php echo base_url(); ?>/public/assets/dist/img/user8-128x128.jpg" alt="User Avatar"
            ...
            <a href="#" class="dropdown-item">
              <!-- Message Start -->
              <div class="media">
                <img src="<?php echo base_url(); ?>/public/assets/dist/img/user3-128x128.jpg" alt="User Avatar"
                  class="img-size-50 img-circle mr-3">
                <div class="media-body">
                  <h3 class="dropdown-item-title">
                    Nora Silvester
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <form method="POST" action="<?= base_url('submitdata/'.$employee['ID'])?>" >
          <div class="card-body">
            <div class="form-group">
              <label for="exampleInputEmail1">Enter name  to update</label>
              <input type="text" class="form-control"  name="FirstName" value="<?= $employee['FirstName'] ?>" id="exampleInputEmail1" placeholder="Enter email">
            </div>
            <input type="hidden" name="ID" value="<? echo $employee['ID'] ?> ">
            <div class="form-group">
              <label for="exampleInputPassword1">Enter Last Name to Update</label>
              <input type="text" class="form-control" name="LastName" value="<?=  $employee['LastName'] ?>" id="exampleInputPassword1" placeholder="Password">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Enter E-mail to Update</label>
              <input type="text" class="form-control" name="email" value="<?= $employee['email']  ?>" id="exampleInputPassword1" placeholder="Password">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Enter Phone Number to Update</label>
              <input type="integer" class="form-control" name="phnumber" value="<?= $employee['phone'] ?>" id="exampleInputPassword1" placeholder="Password">
            </div>
